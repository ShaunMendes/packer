...
# Set HTTP Proxy URL if provided so that the container does not have direct public access
# Also helps restric container access to onl certain resources
if [ -n $PROXY_URL ]
then
...
# So that the containers can commmunicate with each other
